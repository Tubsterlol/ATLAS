from aerospace.satellite.drag import (
    satellite_drag_force
)

from aerospace.satellite.orbit import (
    orbital_velocity
)
...
def altitude_decay_rate(
    ...
    acceleration = (
        drag_force_n / mass_kg
    )

    return acceleration * velocity_ms
